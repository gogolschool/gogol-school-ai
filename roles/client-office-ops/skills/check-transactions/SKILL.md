...
5. **Run reconcile**:
   ...
   verbatim** — the level-1/2 «расхождения» are mostly noise from providers that
   weren't fetched (no token / expired session), and operators find that confusing.
   Instead, reformat into the operator worklist below.
